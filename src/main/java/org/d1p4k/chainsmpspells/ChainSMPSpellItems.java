...
public class ChainSMPSpellItems {
        ...
        static {
                MANA_FLOWER = register(ChainSMPSpellBlocks.MANA_FLOWER);
                MANA_PLANT = register(ChainSMPSpellBlocks.MANA_PLANT);
                MANA_FRUIT = register("chainsmpspells:mana_fruit",new ChorusFruitItem(new Item.Settings().food(FoodComponents.CHORUS_FRUIT)));
                SPELL_BOOK = register(new Identifier("chainsmpspells:spell_book"), new SpellBookItem(new Item.Settings().fireproof().rarity(Rarity.RARE)));
