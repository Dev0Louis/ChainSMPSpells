package org.d1p4k.chainsmpspells.mana.effect;
...
public class ManaEffects {
    ...
    private static void registerPotionRecipe() {
        BrewingRecipeRegistry.registerPotionRecipe(Potions.AWKWARD, ChainSMPSpellItems.MANA_FLOWER, MANA_INSTANT);
        BrewingRecipeRegistry.registerPotionRecipe(MANA_INSTANT, ChainSMPSpellItems.MANA_FLOWER, STRONG_MANA_INSTANT);
    }
