...
public class ChainSMPSpellsItems {
    ...
    public static final Item SPELL_TABLE = Items.register(new Identifier("chainsmpspells:spell_table"), new BlockItem(ChainSMPSpellsBlocks.SPELL_TABLE, new Item.Settings().rarity(Rarity.EPIC)));
